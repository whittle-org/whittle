...
def setup(
    ...
    logger = choose_logger(
        logger_name,
        out_dir,
        name=f"distill-{config.name}-10-subnets",
        resume=bool(resume),
...
def main(
    ...
    for i, subnetwork_config in enumerate(subnetworks):
            ...
            fabric.logger.log_hyperparams({"subnet_id": i, **subnetwork_config})
            ...
            fit(fabric, device, state, train_dataloader, val_dataloader, out_dir, tokenizer_dir, train, eval, distill, i)
