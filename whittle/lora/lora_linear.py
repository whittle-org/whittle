...
class LoRALinearProj(LoRALinear):
    def __init__(
        self,
        in_features: int,
        out_features: int,
    ...
    def set_sub_network(self, sub_network_in_features, sub_network_out_features, proj_indices=None):
        self.sub_network_in_features = sub_network_in_features
        self.sub_network_out_features = sub_network_out_features
        self.linear.set_sub_network(sub_network_in_features, sub_network_out_features, proj_indices)
