...
config = Config.from_file(
    str(
        f"//p/project/projectnucleus/sukthanker1/importance/llm_compression_experiments/checkpoints/microsoft/Phi-3-mini-4k-instruct/"
        + "model_config.yaml"
    )
)
...
with open(
    "/p/project/projectnucleus/sukthanker1/importance/llm_compression_experiments/checkpoints/microsoft/Phi-3-mini-4k-instruct/grid_phi-3_mag_mean.pkl",
    "rb",
) as f:
    a = pickle.load(f)
latencies = []
...
search_space = search_spaces["hw_gpt_bench"](config)
for arch in a:
