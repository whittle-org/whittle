...
config_dict = dict(n_layer=n_layer, n_head=n_head, n_embd=n_embd, block_size=block_size,
                  bias=True, vocab_size=vocab_size,padded_vocab_size=vocab_size, rotary_percentage=1.0, intermediate_size=1024*4)
...
sampled_config = sample_config(choices_dict, layer_sampling_scheme="normal",fix_head=True, fix_mlp_ratio=True, seed=seed)
