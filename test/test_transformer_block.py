...
def test_block():
      ...
      lit_block_small.attn.attn.weight.data = torch.ones_like(lit_block_small.attn.attn.weight.data)
      lit_block_small.attn.attn.bias.data = torch.ones_like(lit_block_small.attn.attn.bias.data)
      lit_block_small.attn.proj.bias.data = torch.ones_like(lit_block_small.attn.proj.bias.data)
      lit_block_small.attn.proj.weight.data = torch.ones_like(lit_block_small.attn.proj.weight.data)
      lit_block_small.mlp.fc_1.weight.data = torch.ones_like(lit_block_small.mlp.fc_1.weight.data)
      lit_block_small.mlp.fc_1.bias.data = torch.ones_like(lit_block_small.mlp.fc_1.bias.data)
      lit_block_small.mlp.fc_2.weight.data = torch.ones_like(lit_block_small.mlp.fc_2.weight.data)
      lit_block_small.mlp.fc_2.bias.data = torch.ones_like(lit_block_small.mlp.fc_2.bias.data)
      lit_block_small.mlp.proj.weight.data = torch.ones_like(lit_block_small.mlp.proj.weight.data)
      lit_block_small.mlp.proj.bias.data = torch.ones_like(lit_block_small.mlp.proj.bias.data)
