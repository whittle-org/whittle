...
class GPT(nn.Module):
    def __init__(self, config: Config) -> None:
        ...
        self.lm_head = LMHeadSuper(config.n_embd, config.padded_vocab_size, bias=config.lm_head_bias)
    ...
    def set_sample_config(self, sample_embed_dim: int, sample_intermediate_size: int, sample_num_heads: int, sample_n_layer: int, sample_layer_indices: list) -> None:
        ...
        for i in sample_layer_indices:
            ...
            block.set_sample_config(sample_embed_dim, sample_intermediate_size[i], sample_num_heads[i])
        self.lm_head.set_sample_config(sample_embed_dim)
