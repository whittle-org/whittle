...
class AutoConfig:
    ...
    embed_choices: Optional[list] = None
    head_choices: Optional[list] = None
    layer_choices: Optional[list] = None
    mlp_ratio_choicea: Optional[list] = None
    ...
    def mlp_class(self) -> Type:
        ...
        if self.mlp_class_name == "LLaMAMLP":
            return LLaMAMLP
        if self.mlp_class_name == "GemmaMLP":
            return GemmaMLP
        raise ValueError(f"Unknown MLP class {self.mlp_class_name!r}")
    ...
    def norm_class(self) -> Type:
        ...
        if self.norm_class_name == "RMSNorm":
            ...
            return partial(RMSNormSuper, add_unit_offset="Gemma" in self.name)
